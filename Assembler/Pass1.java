...
class Pass1 {
    public static void main(String args[]) throws NullPointerException, FileNotFoundException {
        ...
        String line;
        try {
            BufferedReader br = new BufferedReader(new FileReader("C:\\Users\\HP\\Desktop\\Assembler\\Sample.txt"));
            BufferedWriter bw = new BufferedWriter(new FileWriter("C:\\Users\\HP\\Desktop\\Assembler\\Output.txt"));
            Boolean start = false;
        ...
        System.out.println("\n\n**********Output1.txt***********************\n");
        try {
            BufferedReader br = new BufferedReader(new FileReader("C:\\Users\\HP\\Desktop\\Assembler\\Output.txt"));
